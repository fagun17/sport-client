...
import { useUpdateLogTimeAdmin } from './useUpdateLogTimeAdmin'

export const useCompetitionLogAdmin = () => {
	const { id } = useParams()
	...
	const { error, updateTime } = useUpdateLogTimeAdmin(competitionLog?.times)
