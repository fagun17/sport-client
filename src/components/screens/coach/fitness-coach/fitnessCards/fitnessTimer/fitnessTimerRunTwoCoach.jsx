					...
					{isLoading ? (
						...
						<>
							<img
								...
								onClick={() => navigate('/fitness-run-one-coach')}
					...
					{showModal && (
						<div className={style.modalcontainer}>
							<div className={style.modalcontent}>
								...
								<img
									src={
										'https://img.akilexsportswear.com/img/how-to-gain-muscle/144/16-Exercises-From-the-Worlds-Best-Trainers_12.jpg'
									}
									draggable={false}
									width={60}
									height={60}
								...
								<ButtonFitness clickHandler={() => navigate('/run-coach')}>
...
export default FitnessTimerRunTwoCoach
