...
const FitnessTimerCrossfitFourCoach = () => {
	...
	return (
		<>
			...
			>
					...
					{isLoading ? (
						...
						<>
							<img
								...
								onClick={() => navigate('/fitness-crossfit-free-coach')}
				...
				<div class='center'>
					<div class='article-card'>
						<div class='content'>
							...
							<h1 class='title'>Румынская тяга</h1>
						</div>
				...
				<Button clickHandler={() => navigate('/fitness-crossfit-five-coach')}>
...
export default FitnessTimerCrossfitFourCoach
