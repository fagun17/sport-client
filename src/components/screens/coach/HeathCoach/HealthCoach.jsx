...
import style from './HealthCoach.module.scss'
const HealthCoach = () => {
	...
	const [q, setIsQ] = useState(
		'Ожирение 3 степени (морбидное). Необходимо начать худеть!!!'
	)
						...
						<div className={style.modalcontainer}>
							<div className={style.modalcontent}>
								<div className={styles.scrollcontainer}>
									...
									>
										<h2>Анализ параметров вашего здоровья: </h2>
										<p>
											{'Индекс массы вашего тела: '}
											<p style={{ color: '#000' }}>
												{roundToDecimal(
