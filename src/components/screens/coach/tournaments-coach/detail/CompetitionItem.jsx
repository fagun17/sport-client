...
const CompetitionItemCoach = ({ competitionLog }) => {
	...
	return (
		...
		>
			<button
				...
				onClick={() => navigation(`/competition-coach/${competitionLog.id}`)}
			>
				<span>
			...
			<div>
				<button
					...
					onClick={() => navigation('/competition/update')}
				>
...
export default CompetitionItemCoach
