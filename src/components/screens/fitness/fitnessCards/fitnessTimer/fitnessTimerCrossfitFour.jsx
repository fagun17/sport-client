...
const FitnessTimerCrossfitFour = () => {
	...
	return (
		<>
			...
			>
					...
					{isLoading ? (
						...
						<>
							<img
								...
								onClick={() => navigate('/fitnesscrossfitfree')}
				...
				<Button clickHandler={() => navigate('/fitnesscrossfitfive')}>
...
export default FitnessTimerCrossfitFour
