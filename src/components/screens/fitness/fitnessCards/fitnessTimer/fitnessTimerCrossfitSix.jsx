					...
					{isLoading ? (
						...
						<>
							<img
								...
								onClick={() => navigate('/fitnesscrossfitfive')}
					...
					{showModal && (
						<div className={style.modalcontainer}>
							<div className={style.modalcontent}>
								...
								<div>
									<h2 style={{ marginTop: 20 }}>Тренировка выполнена !</h2>
									<img
								...
								<ButtonFitness clickHandler={() => navigate('/crossfits')}>
...
export default FitnessTimerCrossfitSix
